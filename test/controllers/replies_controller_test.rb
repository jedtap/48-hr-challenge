...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference("Reply.count") do
      post replies_url, params: { reply: { comment_id: @reply.comment_id, feedback: @reply.feedback } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { comment_id: @reply.comment_id, feedback: @reply.feedback } }
